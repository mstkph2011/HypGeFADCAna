...
void Pic_2DHistogramsT10ImaxJuneAll(
	...
	TString InputName2 = "/lustre/miifs05/scratch/him-specf/hyp/steinen/COSYBeamtestAna/COSYnewMogon/June2014/HistosTreeCOSYJune2014Dataset14_200,100,0,5339_SR0.root")
{
	...
	for (int i= 0;i<=14;i++) 
	{
		InputNameArray[i]="/lustre/miifs05/scratch/him-specf/hyp/steinen/COSYBeamtestAna/COSYnewMogon/Fit/FitCOSYJune2014Dataset";
		InputNameArray[i]+=i;
		InputNameArray[i]+="_200,100,0,5339_SR0.root";
		InputName2Array[i]="/lustre/miifs05/scratch/him-specf/hyp/steinen/COSYBeamtestAna/COSYnewMogon/June2014/HistosTreeCOSYJune2014Dataset";
		InputName2Array[i]+=i;
	...
	if(SaveImages)
		andi::saveCanvas_allFileNames(Can,TString::Format("%s/Mar_APP_2DHistogramsT10ImaxJuneAll",PicRootDir.Data()));
		return 0;
