...
void FillGraphs(TGraph *Graphs[6],TString Filename,const int nPoints=15,bool inNumberOfNeutrons=1)
{
	...
	char buf[60];CollectionFileJune2014.txt
...
void Pic_Mar_APP_SecondOrderCorrectionJune()
{
	...
	gPad->Update();
		...
		if (1) andi::saveCanvas_allFileNames(Can, "~/pictures/Mar_APP_SecondOrderCorrectionJune" );
