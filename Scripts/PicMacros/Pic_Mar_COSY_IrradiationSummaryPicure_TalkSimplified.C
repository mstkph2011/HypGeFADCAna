...
void Pic_Mar_COSY_IrradiationSummaryPicure_TalkSimplified()
{
	...
	double JuneLabEnergies[2] = {2.25,3.52};
	double JuneLabEnergiesCorr[2] = {2.25,2.67};
	double JuneLabX[2] = {0,5.6};
	
	//"faked" annealing for visualization
	double JuneLabEnergiesCorrShort[1] = {2.25};
	...
	double JuneLabAnnealingEnergies[2]={2.6,2.0};
	...
	double cw =1100*CanvasScaler*0.75;
	...
	if (1) 
		andi::saveCanvas_allFileNames(Can, "~/pictures/Mar_COSY_IrradiationSummaryPicure_TalkSimplified" );
	return 0;
