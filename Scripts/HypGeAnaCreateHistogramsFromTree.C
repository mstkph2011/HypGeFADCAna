...
if(ParameterFilename.Contains(".root"))
{
	...
	funcCorr1_T10DeriMaxEnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T10DeriMaxEnergyNorm_2");
		funcCorr1_T10DeriMaxEnergyNorm_2Corr2_T1090EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T10DeriMaxEnergyNorm_2Corr2_T1090EnergyNorm_2");
		funcCorr1_T10DeriMaxEnergyNorm_2Corr2_TDeriMax90EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T10DeriMaxEnergyNorm_2Corr2_TDeriMax90EnergyNorm_2");
	funcCorr1_T1090EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T1090EnergyNorm_2");
		funcCorr1_T1090EnergyNorm_2Corr2_T10DeriMaxEnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T1090EnergyNorm_2Corr2_T10DeriMaxEnergyNorm_2");
		funcCorr1_T1090EnergyNorm_2Corr2_TDeriMax90EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_T1090EnergyNorm_2Corr2_TDeriMax90EnergyNorm_2");

	funcCorr1_TDeriMax90EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_TDeriMax90EnergyNorm_2");
		funcCorr1_TDeriMax90EnergyNorm_2Corr2_T10DeriMaxEnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_TDeriMax90EnergyNorm_2Corr2_T10DeriMaxEnergyNorm_2");
		funcCorr1_TDeriMax90EnergyNorm_2Corr2_T1090EnergyNorm_2=(TF1*) ParameterFile->Get("funcCorr1_TDeriMax90EnergyNorm_2Corr2_T1090EnergyNorm_2");
...
TH2D * hTDeriMax90EnergyCorr1_T10DeriMaxEnergyNorm_2 = new TH2D("hTDeriMax90EnergyCorr1_T10DeriMax",";t_{Derimax90} [ns];Energy [ADC value]",130,-290,1000,4000,1,4000);
